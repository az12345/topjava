...
public class UserTestData {
    ...
    public static final User USER = new User(USER_ID, "User", "user@yandexTEST.ru", "password", Role.ROLE_USER);
    public static final User ADMIN = new User(ADMIN_ID, "Admin", "admin@gmailTEST.com", "admin", Role.ROLE_ADMIN);
